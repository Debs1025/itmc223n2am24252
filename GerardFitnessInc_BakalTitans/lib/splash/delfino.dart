...
Description: This is where the 3rd splash screen is coded*/

import 'package:flutter/material.dart';
import 'sulit.dart';

// Splash Screen
class DelfinoScreen extends StatelessWidget {
  const DelfinoScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.black,
      // Stack for layering background, gradient and content
      body: Stack(
        fit: StackFit.expand,
        children: [
          // Background Image 
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                image: AssetImage('assets/delfino.jpg'),
                fit: BoxFit.cover,
